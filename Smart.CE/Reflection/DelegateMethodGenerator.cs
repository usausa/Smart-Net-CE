namespace Smart.Reflection
{
    ...
    public static class DelegateMethodGenerator
    {
        ...
        /// <param name="pi"></param>
        /// <returns></returns>
        public static Func<TTarget, TMember> CreateTypedGetDelegate<TTarget, TMember>(PropertyInfo pi) where TTarget : class
        {
        ...
        /// <param name="pi"></param>
        /// <returns></returns>
        public static Action<TTarget, TMember> CreateTypedSetDelegate<TTarget, TMember>(PropertyInfo pi) where TTarget : class
        {
